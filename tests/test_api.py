    ...
    assert api.markets == {
        "GRIN_BTC": {
            ...
            "metadata": {
                ...
                "market_notices": [
                    {
                        "message": "Delisting Notice: This market is being closed. Please cancel your orders and withdraw your funds by 4/11/2019.",
                        "type": "warning",
                    }
                ],
            },
...
def test_order(api):
    ...
    def req_2(
        ...
        **kwargs
        ...
        return {
            "order": {
                "id": 8987684,
                "market_amount": "1.99004975",
                "market_amount_remaining": "1.99004975",
                "created_at": "2019-11-14T23:46:52.897345Z",
                "price": "0.00500000",
                "order_type": "buy_limit",
                "market_id": 1,
    ...
    def req_3(
        ...
        **kwargs
        ...
        return {
            "order": {
                "id": 8987684,
                "market_amount": "0.01000000",
                "market_amount_remaining": "0.01000000",
                "created_at": "2019-11-14T23:46:52.897345Z",
                "price": "1.00000000",
                "order_type": "sell_limit",
                "market_id": 1,
    ...
    try:
        o = api.order("sell_limit", 0.001, value=0.01, amount=0.01, market_id=1)
        raise AssertionError
    except (ValueError):
        pass
    ...
    try:
        o = api.order("sell_limit", 0.001, value=0.01)
        raise AssertionError
    except (ValueError):
        pass
